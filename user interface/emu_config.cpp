...
#include "../cpu core/interpreter/cpu_int.h"
...
void CFG_Enable_Fullscreen(void)
{
	...
	WritePrivateProfileString("Video", "Fullscreen", szbuff, inifile);	
}
...
void CFG_Enable_Framebuffer(void)
{
	...
	WritePrivateProfileString("System", "Framebuffer", szbuff, inifile);
}
...
void CFG_Enable_AutoStart(void)
{
  ...
  if(cfg.enb_autostart)
	...
	WritePrivateProfileString("Emulation", "AutoStart", szbuff, inifile);
}
...
void CFG_Enable_DynaRec(void)
{
	...
	sprintf(INIFile, "%sGekko.ini", ProgramDirectory);
	WritePrivateProfileString("System", "DynaRec", szbuff, INIFile);
...
void CFG_Video_Update_Ini(void)
{
	...
	WritePrivateProfileString("Video", "WindowRes", szbuff, inifile);

	sprintf(szbuff, "%d", gx_cfg.fullscreen_res);
	WritePrivateProfileString("Video", "FullscreenRes", szbuff, inifile);

	sprintf(szbuff, "%d", gx_cfg.shader_mode);
	WritePrivateProfileString("Video", "ShaderMode", szbuff, inifile);
	
	sprintf(szbuff, "%d", gx_cfg.full_screen);
	WritePrivateProfileString("Video", "Fullscreen", szbuff, inifile);

	sprintf(szbuff, "%d", gx_cfg.anti_aliasing);
	WritePrivateProfileString("Video", "AntiAliasing", szbuff, inifile);

	sprintf(szbuff, "%d", gx_cfg.anistropic_filtering);
	WritePrivateProfileString("Video", "AnistropicFiltering", szbuff, inifile);

	sprintf(szbuff, "%d", gx_cfg.wireframe);
	WritePrivateProfileString("Video", "Wireframe", szbuff, inifile);

	sprintf(szbuff, "%d", gx_cfg.dump_textures);
	WritePrivateProfileString("Video", "DumpTextures", szbuff, inifile);

	sprintf(szbuff, "%d", gx_cfg.force_white);
	WritePrivateProfileString("Video", "ForceWhite", szbuff, inifile);
	
	sprintf(szbuff, "%d", gx_cfg.force_alpha);
	WritePrivateProfileString("Video", "ForceAlpha", szbuff, inifile);
}
...
void CFG_Video_Get_Ini(void)
{
	...
	gx_cfg.window_res = GetPrivateProfileInt("Video", "WindowRes", 0, inifile);
	gx_cfg.fullscreen_res = GetPrivateProfileInt("Video", "FullscreenRes", 0, inifile);
	gx_cfg.shader_mode = GetPrivateProfileInt("Video", "ShaderMode", 0, inifile);
	gx_cfg.full_screen = GetPrivateProfileInt("Video", "Fullscreen", 0, inifile);
	gx_cfg.anti_aliasing = GetPrivateProfileInt("Video", "AntiAliasing", 0, inifile);
	gx_cfg.anistropic_filtering = GetPrivateProfileInt("Video", "AnistropicFiltering", 0, inifile);
	gx_cfg.wireframe = GetPrivateProfileInt("Video", "Wireframe", 0, inifile);
	gx_cfg.dump_textures = GetPrivateProfileInt("Video", "DumpTextures", 0, inifile);
	gx_cfg.force_white = GetPrivateProfileInt("Video", "ForceWhite", 0, inifile);
	gx_cfg.force_alpha = GetPrivateProfileInt("Video", "ForceAlpha", 0, inifile);
}
...
BOOL CALLBACK CFG_Video_Proc(HWND _hwnd, UINT _umsg, WPARAM _wparam, LPARAM _lparam)
{
    ...
    switch(_umsg)
    {
        case WM_INITDIALOG:
			...
			SetDlgItemText(_hwnd, IDC_VIDEO_DEVICE, str1);
...
void CFG_Joypad_Update_Ini(void)
{
	...
	WritePrivateProfileString("Joypad", "Pad0Enable", szbuff, inifile);
	sprintf(szbuff, "%d", jp_cfg.pads[0].a);
	WritePrivateProfileString("Joypad", "Pad0AKey", szbuff, inifile);
	sprintf(szbuff, "%d", jp_cfg.pads[0].b);
	WritePrivateProfileString("Joypad", "Pad0BKey", szbuff, inifile);
	sprintf(szbuff, "%d", jp_cfg.pads[0].x);
	WritePrivateProfileString("Joypad", "Pad0XKey", szbuff, inifile);
	sprintf(szbuff, "%d", jp_cfg.pads[0].y);
	WritePrivateProfileString("Joypad", "Pad0YKey", szbuff, inifile);
	sprintf(szbuff, "%d", jp_cfg.pads[0].l);
	WritePrivateProfileString("Joypad", "Pad0LKey", szbuff, inifile);
	sprintf(szbuff, "%d", jp_cfg.pads[0].r);
	WritePrivateProfileString("Joypad", "Pad0RKey", szbuff, inifile);
	sprintf(szbuff, "%d", jp_cfg.pads[0].z);
	WritePrivateProfileString("Joypad", "Pad0ZKey", szbuff, inifile);
	sprintf(szbuff, "%d", jp_cfg.pads[0].start);
	WritePrivateProfileString("Joypad", "Pad0StartKey", szbuff, inifile);
	sprintf(szbuff, "%d", jp_cfg.pads[0].analog[0]);
	WritePrivateProfileString("Joypad", "Pad0Analog0Key", szbuff, inifile);
	sprintf(szbuff, "%d", jp_cfg.pads[0].analog[1]);
	WritePrivateProfileString("Joypad", "Pad0Analog1Key", szbuff, inifile);
	sprintf(szbuff, "%d", jp_cfg.pads[0].analog[2]);
	WritePrivateProfileString("Joypad", "Pad0Analog2Key", szbuff, inifile);
	sprintf(szbuff, "%d", jp_cfg.pads[0].analog[3]);
	WritePrivateProfileString("Joypad", "Pad0Analog3Key", szbuff, inifile);
	sprintf(szbuff, "%d", jp_cfg.pads[0].cstick[0]);
	WritePrivateProfileString("Joypad", "Pad0CStick0Key", szbuff, inifile);
	sprintf(szbuff, "%d", jp_cfg.pads[0].cstick[1]);
	WritePrivateProfileString("Joypad", "Pad0CStick1Key", szbuff, inifile);
	sprintf(szbuff, "%d", jp_cfg.pads[0].cstick[2]);
	WritePrivateProfileString("Joypad", "Pad0CStick2Key", szbuff, inifile);
	sprintf(szbuff, "%d", jp_cfg.pads[0].cstick[3]);
	WritePrivateProfileString("Joypad", "Pad0CStick3Key", szbuff, inifile);
	sprintf(szbuff, "%d", jp_cfg.pads[0].dpad[0]);
	WritePrivateProfileString("Joypad", "Pad0DPad0Key", szbuff, inifile);
	sprintf(szbuff, "%d", jp_cfg.pads[0].dpad[1]);
	WritePrivateProfileString("Joypad", "Pad0DPad1Key", szbuff, inifile);
	sprintf(szbuff, "%d", jp_cfg.pads[0].dpad[2]);
	WritePrivateProfileString("Joypad", "Pad0DPad2Key", szbuff, inifile);
	sprintf(szbuff, "%d", jp_cfg.pads[0].dpad[3]);
	WritePrivateProfileString("Joypad", "Pad0DPad3Key", szbuff, inifile);
...
void CFG_Joypad_Get_Ini(void)
{
	...
	jp_cfg.pads[0].is_on = GetPrivateProfileInt("Joypad", "Pad0Enable", 0, inifile);
	jp_cfg.pads[0].a = GetPrivateProfileInt("Joypad", "Pad0AKey", 0, inifile);
	jp_cfg.pads[0].b = GetPrivateProfileInt("Joypad", "Pad0BKey", 0, inifile);
	jp_cfg.pads[0].x = GetPrivateProfileInt("Joypad", "Pad0XKey", 0, inifile);
	jp_cfg.pads[0].y = GetPrivateProfileInt("Joypad", "Pad0YKey", 0, inifile);
	jp_cfg.pads[0].l = GetPrivateProfileInt("Joypad", "Pad0LKey", 0, inifile);
	jp_cfg.pads[0].r = GetPrivateProfileInt("Joypad", "Pad0RKey", 0, inifile);
	jp_cfg.pads[0].z = GetPrivateProfileInt("Joypad", "Pad0ZKey", 0, inifile);
	jp_cfg.pads[0].start = GetPrivateProfileInt("Joypad", "Pad0StartKey", 0, inifile);
	jp_cfg.pads[0].analog[0] = GetPrivateProfileInt("Joypad", "Pad0Analog0Key", 0, inifile);
	jp_cfg.pads[0].analog[1] = GetPrivateProfileInt("Joypad", "Pad0Analog1Key", 0, inifile);
	jp_cfg.pads[0].analog[2] = GetPrivateProfileInt("Joypad", "Pad0Analog2Key", 0, inifile);
	jp_cfg.pads[0].analog[3] = GetPrivateProfileInt("Joypad", "Pad0Analog3Key", 0, inifile);
	jp_cfg.pads[0].cstick[0] = GetPrivateProfileInt("Joypad", "Pad0CStick0Key", 0, inifile);
	jp_cfg.pads[0].cstick[1] = GetPrivateProfileInt("Joypad", "Pad0CStick1Key", 0, inifile);
	jp_cfg.pads[0].cstick[2] = GetPrivateProfileInt("Joypad", "Pad0CStick2Key", 0, inifile);
	jp_cfg.pads[0].cstick[3] = GetPrivateProfileInt("Joypad", "Pad0CStick3Key", 0, inifile);
	jp_cfg.pads[0].dpad[0] = GetPrivateProfileInt("Joypad", "Pad0DPad0Key", 0, inifile);
	jp_cfg.pads[0].dpad[1] = GetPrivateProfileInt("Joypad", "Pad0DPad1Key", 0, inifile);
	jp_cfg.pads[0].dpad[2] = GetPrivateProfileInt("Joypad", "Pad0DPad2Key", 0, inifile);
	jp_cfg.pads[0].dpad[3] = GetPrivateProfileInt("Joypad", "Pad0DPad3Key", 0, inifile);
...
{
	SetDlgItemText(_hwnd, IDC_JOYPAD_STATIC_START, cfg_keyboard_text[jp_cfg.pads[jp_cfg.joypad_select].start]);
	SetDlgItemText(_hwnd, IDC_JOYPAD_STATIC_A, cfg_keyboard_text[jp_cfg.pads[jp_cfg.joypad_select].a]);
	SetDlgItemText(_hwnd, IDC_JOYPAD_STATIC_B, cfg_keyboard_text[jp_cfg.pads[jp_cfg.joypad_select].b]);
	SetDlgItemText(_hwnd, IDC_JOYPAD_STATIC_X, cfg_keyboard_text[jp_cfg.pads[jp_cfg.joypad_select].x]);
	SetDlgItemText(_hwnd, IDC_JOYPAD_STATIC_Y, cfg_keyboard_text[jp_cfg.pads[jp_cfg.joypad_select].y]);
	SetDlgItemText(_hwnd, IDC_JOYPAD_STATIC_L, cfg_keyboard_text[jp_cfg.pads[jp_cfg.joypad_select].l]);
	SetDlgItemText(_hwnd, IDC_JOYPAD_STATIC_R, cfg_keyboard_text[jp_cfg.pads[jp_cfg.joypad_select].r]);
	SetDlgItemText(_hwnd, IDC_JOYPAD_STATIC_Z, cfg_keyboard_text[jp_cfg.pads[jp_cfg.joypad_select].z]);
	SetDlgItemText(_hwnd, IDC_JOYPAD_STATIC_ANALOGUP, cfg_keyboard_text[jp_cfg.pads[jp_cfg.joypad_select].analog[0]]);
	SetDlgItemText(_hwnd, IDC_JOYPAD_STATIC_ANALOGDOWN, cfg_keyboard_text[jp_cfg.pads[jp_cfg.joypad_select].analog[1]]);
	SetDlgItemText(_hwnd, IDC_JOYPAD_STATIC_ANALOGLEFT, cfg_keyboard_text[jp_cfg.pads[jp_cfg.joypad_select].analog[2]]);
	SetDlgItemText(_hwnd, IDC_JOYPAD_STATIC_ANALOGRIGHT, cfg_keyboard_text[jp_cfg.pads[jp_cfg.joypad_select].analog[3]]);
	SetDlgItemText(_hwnd, IDC_JOYPAD_STATIC_CUP, cfg_keyboard_text[jp_cfg.pads[jp_cfg.joypad_select].cstick[0]]);
	SetDlgItemText(_hwnd, IDC_JOYPAD_STATIC_CDOWN, cfg_keyboard_text[jp_cfg.pads[jp_cfg.joypad_select].cstick[1]]);
	SetDlgItemText(_hwnd, IDC_JOYPAD_STATIC_CLEFT, cfg_keyboard_text[jp_cfg.pads[jp_cfg.joypad_select].cstick[2]]);
	SetDlgItemText(_hwnd, IDC_JOYPAD_STATIC_CRIGHT, cfg_keyboard_text[jp_cfg.pads[jp_cfg.joypad_select].cstick[3]]);
	SetDlgItemText(_hwnd, IDC_JOYPAD_STATIC_DUP, cfg_keyboard_text[jp_cfg.pads[jp_cfg.joypad_select].dpad[0]]);
	SetDlgItemText(_hwnd, IDC_JOYPAD_STATIC_DDOWN, cfg_keyboard_text[jp_cfg.pads[jp_cfg.joypad_select].dpad[1]]);
	SetDlgItemText(_hwnd, IDC_JOYPAD_STATIC_DLEFT, cfg_keyboard_text[jp_cfg.pads[jp_cfg.joypad_select].dpad[2]]);
	SetDlgItemText(_hwnd, IDC_JOYPAD_STATIC_DRIGHT, cfg_keyboard_text[jp_cfg.pads[jp_cfg.joypad_select].dpad[3]]);
}
...
BOOL CALLBACK CFG_Joypad_Proc(HWND _hwnd, UINT _umsg, WPARAM _wparam, LPARAM _lparam)
{
    switch(_umsg)
    {
        case WM_INITDIALOG:
			...
			SetDlgItemText(_hwnd, IDC_JOYPAD_GROUP, str1);
        ...
        case WM_COMMAND:
            switch(LOWORD(_wparam))
            {
				...
				case IDC_JOYPAD_CRIGHT:
					...
					SetWindowText(_hwnd, "Joypad Settings (Waiting for key press...)");
		...
		if (msg.message == WM_KEYDOWN && waiting_for_input)
		{
			...
			switch(button_pressed)
			{
				case IDC_JOYPAD_A:
					...
					SetDlgItemText(hWnd, IDC_JOYPAD_STATIC_A, cfg_keyboard_text[msg.wParam]);
					break;
				case IDC_JOYPAD_B:
					jp_cfg.pads[jp_cfg.joypad_select].b = msg.wParam;
					SetDlgItemText(hWnd, IDC_JOYPAD_STATIC_B, cfg_keyboard_text[msg.wParam]);
					break;
				case IDC_JOYPAD_X:
					jp_cfg.pads[jp_cfg.joypad_select].x = msg.wParam;
					SetDlgItemText(hWnd, IDC_JOYPAD_STATIC_X, cfg_keyboard_text[msg.wParam]);
					break;
				case IDC_JOYPAD_Y:
					jp_cfg.pads[jp_cfg.joypad_select].y = msg.wParam;
					SetDlgItemText(hWnd, IDC_JOYPAD_STATIC_Y, cfg_keyboard_text[msg.wParam]);
					break;
				case IDC_JOYPAD_L:
					jp_cfg.pads[jp_cfg.joypad_select].l = msg.wParam;
					SetDlgItemText(hWnd, IDC_JOYPAD_STATIC_L, cfg_keyboard_text[msg.wParam]);
					break;
				case IDC_JOYPAD_R:
					jp_cfg.pads[jp_cfg.joypad_select].r = msg.wParam;
					SetDlgItemText(hWnd, IDC_JOYPAD_STATIC_R, cfg_keyboard_text[msg.wParam]);
					break;
				case IDC_JOYPAD_Z:
					jp_cfg.pads[jp_cfg.joypad_select].z = msg.wParam;
					SetDlgItemText(hWnd, IDC_JOYPAD_STATIC_Z, cfg_keyboard_text[msg.wParam]);
					break;
				case IDC_JOYPAD_START:
					jp_cfg.pads[jp_cfg.joypad_select].start = msg.wParam;
					SetDlgItemText(hWnd, IDC_JOYPAD_STATIC_START, cfg_keyboard_text[msg.wParam]);
					break;
				case IDC_JOYPAD_ANALOGUP:
					jp_cfg.pads[jp_cfg.joypad_select].analog[0] = msg.wParam;
					SetDlgItemText(hWnd, IDC_JOYPAD_STATIC_ANALOGUP, cfg_keyboard_text[msg.wParam]);
					break;
				case IDC_JOYPAD_ANALOGDOWN:
					jp_cfg.pads[jp_cfg.joypad_select].analog[1] = msg.wParam;
					SetDlgItemText(hWnd, IDC_JOYPAD_STATIC_ANALOGDOWN, cfg_keyboard_text[msg.wParam]);
					break;
				case IDC_JOYPAD_ANALOGLEFT:
					jp_cfg.pads[jp_cfg.joypad_select].analog[2] = msg.wParam;
					SetDlgItemText(hWnd, IDC_JOYPAD_STATIC_ANALOGLEFT, cfg_keyboard_text[msg.wParam]);
					break;
				case IDC_JOYPAD_ANALOGRIGHT:
					jp_cfg.pads[jp_cfg.joypad_select].analog[3] = msg.wParam;
					SetDlgItemText(hWnd, IDC_JOYPAD_STATIC_ANALOGRIGHT, cfg_keyboard_text[msg.wParam]);
					break;
				case IDC_JOYPAD_DUP:
					jp_cfg.pads[jp_cfg.joypad_select].dpad[0] = msg.wParam;
					SetDlgItemText(hWnd, IDC_JOYPAD_STATIC_DUP, cfg_keyboard_text[msg.wParam]);
					break;
				case IDC_JOYPAD_DDOWN:
					jp_cfg.pads[jp_cfg.joypad_select].dpad[1] = msg.wParam;
					SetDlgItemText(hWnd, IDC_JOYPAD_STATIC_DDOWN, cfg_keyboard_text[msg.wParam]);
					break;
				case IDC_JOYPAD_DLEFT:
					jp_cfg.pads[jp_cfg.joypad_select].dpad[2] = msg.wParam;
					SetDlgItemText(hWnd, IDC_JOYPAD_STATIC_DLEFT, cfg_keyboard_text[msg.wParam]);
					break;
				case IDC_JOYPAD_DRIGHT:
					jp_cfg.pads[jp_cfg.joypad_select].dpad[3] = msg.wParam;
					SetDlgItemText(hWnd, IDC_JOYPAD_STATIC_DRIGHT, cfg_keyboard_text[msg.wParam]);
					break;
				case IDC_JOYPAD_CUP:
					jp_cfg.pads[jp_cfg.joypad_select].cstick[0] = msg.wParam;
					SetDlgItemText(hWnd, IDC_JOYPAD_STATIC_CUP, cfg_keyboard_text[msg.wParam]);
					break;
				case IDC_JOYPAD_CDOWN:
					jp_cfg.pads[jp_cfg.joypad_select].cstick[1] = msg.wParam;
					SetDlgItemText(hWnd, IDC_JOYPAD_STATIC_CDOWN, cfg_keyboard_text[msg.wParam]);
					break;
				case IDC_JOYPAD_CLEFT:
					jp_cfg.pads[jp_cfg.joypad_select].cstick[2] = msg.wParam;
					SetDlgItemText(hWnd, IDC_JOYPAD_STATIC_CLEFT, cfg_keyboard_text[msg.wParam]);
					break;
				case IDC_JOYPAD_CRIGHT:
					jp_cfg.pads[jp_cfg.joypad_select].cstick[3] = msg.wParam;
					SetDlgItemText(hWnd, IDC_JOYPAD_STATIC_CRIGHT, cfg_keyboard_text[msg.wParam]);
					break;
			}
			waiting_for_input = 0;
			SetWindowText(hWnd, "Joypad Settings");
		}
