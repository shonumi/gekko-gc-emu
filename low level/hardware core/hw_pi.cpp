...
{
	printf(".Flipper: Undefined PI_Read8: %08X!\n", addr);
	return 0;
}

void __fastcall PI_Write8(u32 addr, u32 data)
{
	printf(".Flipper: Undefined PI_Write8: %08X := %08X !\n", addr, data);
}
...
u16 __fastcall PI_Read16(u32 addr)
{
	...
	case (PI_CONSOLE_TYPE + 2):
		return REGPI16(addr);
	default:
		printf(".Flipper: Undefined PI_Read16: %08X!\n", addr);
		return 0;
	}
}
...
void __fastcall PI_Write16(u32 addr, u32 data)
{
	...
	case (PI_CONSOLE_TYPE + 2):
		...
		return;
	default:
		printf(".Flipper: Undefined PI_Write16: %08X := %08X !\n", addr, data);
		return;
	}
}
...
u32 __fastcall PI_Read32(u32 addr)
{
    ...
    case PI_CONSOLE_TYPE:
		return REGPI32(addr);
	default:
		printf(".Flipper: Undefined PI_Read32: %08X!\n", addr);
		return 0;
	}
}
...
void __fastcall PI_Write32(u32 addr, u32 data)
{
    ...
    case PI_CONSOLE_TYPE:
		...
		return;
	default:
		printf(".Flipper: Undefined PI_Write32: %08X := %08X !\n", addr, data);
		return;
	}
}
