...
{
	printf(".Flipper: Undefined AI_Read8: %08X!\n", addr);
	return 0;
}

void __fastcall AI_Write8(u32 addr, u32 data)
{
	printf(".Flipper: Undefined AI_Write8: %08X := %08X !\n", addr, data);
}
...
u16 __fastcall AI_Read16(u32 addr)
{
	...
	{
	default:
		printf(".Flipper: Undefined AI_Read16: %08X!\n", addr);
		return 0;
	}
}
...
void __fastcall AI_Write16(u32 addr, u32 data)
{
	...
	{
	default:
		printf(".Flipper: Undefined AI_Write16: %08X := %08X !\n", addr, data);
		return;
	}
}
...
u32 __fastcall AI_Read32(u32 addr)
{
	...
	default:
		printf(".Flipper: Undefined AI_Read32: %08X!\n", addr);
		return 0;
	}
}
...
void __fastcall AI_Write32(u32 addr, u32 data)
{
	...
	default:
		printf(".Flipper: Undefined AI_Write32: %08X := %08X !\n", addr, data);
		return;
	}
}
