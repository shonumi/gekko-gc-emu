...
{
	printf(".Flipper: Undefined CP_Read8: %08X!\n", addr);
	return 0;
}

void __fastcall CP_Write8(u32 addr, u32 data)
{
	printf(".Flipper: Undefined CP_Write8: %08X := %08X !\n", addr, data);
}
...
u16 __fastcall CP_Read16(u32 addr)
{
	...
	default:
		printf(".Flipper: Undefined CP_Read16: %08X!\n", addr);
		return 0;
	}
}
...
void __fastcall CP_Write16(u32 addr, u32 data)
{
	...
	default:
		printf(".Flipper: Undefined CP_Write16: %08X := %08X !\n", addr, data);
		return;
	}
}
