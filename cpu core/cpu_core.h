...
typedef void(__fastcall *GekkoFP)(void);
typedef void GekkoF;
...
protected:
	...
	static optable		GekkoCPU::GekkoCPUOpsGroup4XO0Table[0x400];
	static optable		GekkoCPU::GekkoCPUOpsGroup4Table[0x20];
	static optable		GekkoCPU::GekkoCPUOpsGroup19Table[0x400];
	static optable		GekkoCPU::GekkoCPUOpsGroup31Table[0x400];
	static optable		GekkoCPU::GekkoCPUOpsGroup59Table[0x400];
	static optable		GekkoCPU::GekkoCPUOpsGroup63XO0Table[0x400];
	static optable		GekkoCPU::GekkoCPUOpsGroup63Table[0x20];
	static optable		GekkoCPU::GekkoCPUOpset[0x40];
