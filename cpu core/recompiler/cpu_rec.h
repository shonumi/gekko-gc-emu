...
private:
	...
	static _t128 FPR_SignBit;
	static _t128 FPR_SignBitLow;
	static _t128 FPR_SignBitInverse;
	static _t128 FPR_SignBitInverseLow;
	static _t128 FPR_Negative1;
	static _t128 FPR_Negative1Low;

public:
	GekkoF DumpInternalData(u32 DumpPC, u32 DumpLen);

	static const _t128 ldScale64bit[64];
	static const _t128 ldScale64bitX1[64];
	static const _t128 FPR1Float;
