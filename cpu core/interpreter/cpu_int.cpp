...
#include "../../user interface/debugger/DebugInterface.h"
#include "../../user interface/debugger/GekkoDbgInterface.h"
...
//	pPC = (u32*)&RAM[ireg.PC & RAM_MASK];
	...
	printf(".CPU: Gekko Interpreter Opened.\n");
}
